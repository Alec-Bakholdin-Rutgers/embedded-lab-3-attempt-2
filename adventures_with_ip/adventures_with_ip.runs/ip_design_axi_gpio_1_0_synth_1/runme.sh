...
HD_PWD='/home/user/lab3/adventures_with_ip/adventures_with_ip.runs/ip_design_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_design_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_design_axi_gpio_1_0.tcl
